...
> 1. **Is this simple?** Can a junior developer understand the logic flow without a 10-minute explanation?
> 2. Is this the most performant way to handle the audio buffer?
> 3. Will this block the Main Thread (Hotkey listener)?
> 4. Does this handle the "Permission Denied" case on macOS?
> 5. Is the code "DRY" (Don't Repeat Yourself) but not over-abstracted?
